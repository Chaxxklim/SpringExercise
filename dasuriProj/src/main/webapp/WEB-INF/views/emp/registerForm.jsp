...
<form:form modelAttribute="member" method="post"
	...
	<table>
		...
		<tr>
			<td><form:label path="developer">개발자인가?</form:label></td>
			<td>
		...
		<tr>
			<td><form:label path="foreigner">외국인?</form:label></td>
			<td>
		...
		<tr>
			<td><form:label path="carList">차량</form:label></td>
			<td>
				<form:select path="carList" items="${carMap }" multiple="true"/>
